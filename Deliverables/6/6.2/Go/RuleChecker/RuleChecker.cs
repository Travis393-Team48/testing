...
namespace RuleCheckerSpace
{
    static class RuleChecker
    {
        ...
        public static bool Play(string stone, string point, string[][][] boards)
        {
            ...
            {
                boardObject = new BoardWrapper(board);
            ...
            {
                boardObject = new BoardWrapper(boards[i]);
            ...
            //Rule 7a
            boardObject = new BoardWrapper(boards[0]);
            try
            {
            ...
            {
                throw new RuleCheckerException("Illegal Move in Play: cannot place stones on occupied points");
            }
